					...
					<section id="farms" class="wrapper style1 align-center">
						<div class="inner" >
							...
							<p style="padding-left:65px;padding-right:65px;">
								All of our farm partners use the food waste as a feedstock for insects, livestock and local fertilizer production.
								This helps reduce green house gas, and supports healthy land management practices without using imported chemical fertilizers.
